...
shared (initMsg) actor class StakingPool(initArgs : Types.InitRequests) : async Types.IStakingPool = this {
    ...
    public shared (msg) func deposit() : async Result.Result<Text, Text> {
        ...
        if (Text.notEqual(initArgs.stakingToken.standard, "DIP20") and Text.notEqual(initArgs.stakingToken.standard, "ICP") and Text.notEqual(initArgs.stakingToken.standard, "ICRC1") and Text.notEqual(initArgs.stakingToken.standard, "ICRC2")) {
